...
from core.serializers import UserListSerializer, UserCreateSerializer
...
#         self.URLS = {
#                     'register-api': reverse('core-api:register-api'),
#                     'login-api': reverse('core-api:login-api'),
#                     'user-api': reverse('core-api:user-api'),
#                     'project-api': reverse('core-api:project-api'),
#                      }
